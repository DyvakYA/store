...
public class DeleteOrderProductCommandValidator extends AbstractValidator implements CommandValidator {
    ...
    public boolean validate(HttpServletRequest request, HttpServletResponse response) {
        ...
        return isNullValidate(new String[]{ORDER_PRODUCT_ID_ATTRIBUTE}, RESULT_ATTRIBUTE,
                roleCheckerSetAttributes(ORDER_JSP, request), message, request, response);
    }
}
