...
public class DeleteUserCommandValidator extends AbstractValidator implements CommandValidator {
    ...
    public boolean validate(HttpServletRequest request, HttpServletResponse response) {
        ...
        return isNullValidate(new String[]{USER_ID_ATTRIBUTE}, RESULT_ATTRIBUTE,
                roleCheckerSetAttributes(USER_JSP, request), message, request, response)
                &&
                isEmptyValidate(new String[]{USER_ID_ATTRIBUTE}, RESULT_ATTRIBUTE,
                roleCheckerSetAttributes(USER_JSP, request), message, request, response);
    }
}
