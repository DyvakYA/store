...
public class CreateUserCommandValidator extends AbstractValidator implements CommandValidator {
    ...
    public boolean validate(HttpServletRequest request, HttpServletResponse response) {
        ...
        return isEmptyValidate(new String[]{USER_EMAIL_ATTRIBUTE, USER_AUTHENTICATE_ATTRIBUTE},
