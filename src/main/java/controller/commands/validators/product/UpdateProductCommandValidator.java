...
public class UpdateProductCommandValidator extends AbstractValidator implements CommandValidator {
    ...
    public boolean validate(HttpServletRequest request, HttpServletResponse response) {
        ...
        return isNullValidate(new String[]{PRODUCT_ID_ATTRIBUTE},
                RESULT_ATTRIBUTE, roleCheckerSetAttributes(PRODUCT_JSP, request), message, request, response)
                &&
                isEmptyValidate(new String[]{PRODUCT_ID_ATTRIBUTE},
                RESULT_ATTRIBUTE, roleCheckerSetAttributes(PRODUCT_JSP, request), message, request, response);
    }
}