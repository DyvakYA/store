...
public abstract class DaoFactory {
    ...
    public abstract OrderProductDao createOrderProductDao(DaoConnection connection);

    public abstract UserOrderDao createUserOrderDao(DaoConnection connection);
